  ...
  constructor(private client: DataForSEOClient) {
    ...
    this.fields = [
      "domain",
       ...
       "metrics.organic.etv",
       "metrics.organic.is_new",
       "metrics.organic.is_up",
       "metrics.organic.is_down",
      
       "competitor_metrics.organic.pos_1",
       "competitor_metrics.organic.pos_2_3",
       "competitor_metrics.organic.pos_4_10",
       "competitor_metrics.organic.etv",
       "competitor_metrics.organic.is_new",
       "competitor_metrics.organic.is_up",
       "competitor_metrics.organic.is_down",
