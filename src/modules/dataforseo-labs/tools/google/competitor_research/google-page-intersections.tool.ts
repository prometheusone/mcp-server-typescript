...
export class GooglePageIntersectionsTool extends BaseTool {
  constructor(private client: DataForSEOClient) {
    ...
    this.fields = [
      ...
      "intersection_result.*.type",
      "intersection_result.*.rank_absolute",
      "intersection_result.*.title",
      "intersection_result.*.domain",
      "intersection_result.*.description",
      "intersection_result.*.etv"
    ]
  }
